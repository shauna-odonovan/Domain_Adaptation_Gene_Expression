...
while True:
        ...
        with tf.Session(graph=graph) as sess:
            ...
            for i in range(num_steps):
                ...
                if verbose and p*100 in[0,25,50,75]: 
                    ...
                    with open("midterm/STEATOSIS_pred_dom_720LE_L1O_matched/interval_"+ str(p*100) + '_' + str(i_one) + ".p", "wb") as outfile:
                        pickle.dump((t_mse,
                                    v_mse,
                                    embed_encoder1,
                                    embed_encoder2,
    ...
    with open("export/STEATOSIS_pred_dom_720LE_L1O_matched/predictions_" + str(i_one) + ".p", "wb") as outfile:
    ...
    if PLOT_EMBEDDING:
        ...
        plt.savefig('plots/STEATOSIS_pred_dom_720LE_L1O_matched/' + PLOT_PREFIX + 'latentTrain' + str(i_one))
        ...
        plt.savefig('plots/STEATOSIS_pred_dom_720LE_L1O_matched/' + PLOT_PREFIX + 'latentValidate'+ str(i_one))
        ...
        plt.savefig('plots/STEATOSIS_pred_dom_720LE_L1O_matched/' + PLOT_PREFIX + 'latent_GTX_'+ str(i_one))
        ...
        plt.savefig('plots/STEATOSIS_pred_dom_720LE_L1O_matched/' + PLOT_PREFIX + 'latent_C_'+ str(i_one))
        ...
        if NUMBER_OF_PREDICTION_PLOTS > -1:
            for ind in rnd_train_indices[:NUMBER_OF_PREDICTION_PLOTS]:
                prediction_plot_nones(source_x=source_x_train_nones,
                                      ...
                                      title='Training',
                                      labels=labels_train)
                plt.savefig('plots/STEATOSIS_pred_dom_720LE_L1O/' + PLOT_PREFIX + 'train' + str(ind))
            ...
            for ind in rnd_valid_indices[:NUMBER_OF_PREDICTION_PLOTS]:
                prediction_plot_nones(source_x=source_x_valid_nones,
                                      ...
                                      title='Validation',
                                      labels=labels_valid)
                plt.savefig('plots/STEATOSIS_pred_dom_720LE_L1O/' + PLOT_PREFIX + 'valid' + str(ind) + str(i_one))
